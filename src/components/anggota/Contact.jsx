...
import Bgperpus from '/hero_bg.jpg';
...
<div className="bg-[#eaf6f8] pt-16 px-4">
...
<footer className="bg-[#0a2a43] py-12 px-4 md:px-16">
  <div className="grid grid-cols-1 md:grid-cols-4 gap-10 max-w-6xl mx-auto text-gray-200 text-sm">
    {/* Logo & Description */}
    <div>
